...
def remove_watchlist(request, listing_id):
    info = listing_info(request, listing_id)
    listing, user, owner, category, comments, watch = info[0], info[1], info[2], info[3], info[4], info[5]
...
def add_watchlist(request, listing_id):
    info = listing_info(request, listing_id)
    listing, user, owner, category, comments = info[0], info[1], info[2], info[3], info[4]
